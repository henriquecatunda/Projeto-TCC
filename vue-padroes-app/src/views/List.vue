<template>
  <div class="Conteiner">
    ...
    <div class="boxContainer">
      ...
      v-for="(atividade, index) in tutorial"
      :key="index">
...
export default {
  ...
  mounted() {
    DataController.getAll().on("value", this.onDataChange);
  },
  beforeDestroy() {
    DataController.getAll().off("value", this.onDataChange);
  }
};
</script>
